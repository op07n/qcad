...
public:
	/** 
	* Default constructor. Leaves the data object uninitialied.
	*/
	RS_DimAngularData() {}
	...
	*
	* @param definitionPoint Definition point of the augular dimension.h
	...
	*/
	...
	friend std::ostream& operator << (std::ostream& os,
		...
		os << "("<< dd.definitionPoint1<<"/"<<dd.definitionPoint2<<"/"
			<< dd.definitionPoint3 << "/" <<dd.definitionPoint4<<")";
		return  os;
	}
public:
	/** Definition point 1. */
...
public:
	...
	*/
	...
	double getAngle();
	RS_Vector getCenter();
	bool getAngles(double& ang1, double& ang2, bool& reserved,
